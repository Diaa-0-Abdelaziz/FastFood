...
export default async function subIngredients({params}) {
    const name = params[`sub-Ingredient`];
    ...
    <div className="caregory content">
      ...
      <div className="row">
        ...
        <div className="col-md-3 p-2" key={category.idMeal}>
           <Link href={`./sub-ingredient/${category.idMeal}`}>
           ...
           <Image priority loading="eager" width={600} height={200} src={category.strMealThumb} className=' w-100 h-100 image'  alt={category.strMealThumb}/>
            <div className="categor position-absolute d-flex justify-content-center align-items-center">
